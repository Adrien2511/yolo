...
def localisation_objet():
    ...
    capture = cv2.VideoCapture(0) #ouverture webcam
    ...
    while True:
        ...
        if ouvert==True:  #si la caméra est bien détectée --> True
            ...
            r_image = yolo_model.image_detection(image_yolo) #permet de détecter l'image par rapport au modèle yolo utilisé
